...
plaId int primary key not null,
plsStatus varchar(25) not null
);
alter table playerStatus AUTO_INCREMENT=1;
...
add constraint FK_Player_Status foreign key (plaId) references players(plaId);
