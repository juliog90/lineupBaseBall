...
CREATE TABLE `league` (
  ...
  `id_S` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id_L`),
  KEY `id_S` (`id_S`),
  CONSTRAINT `league_ibfk_1` FOREIGN KEY (`id_S`) REFERENCES `season` (`id_S`)
...
CREATE TABLE `player` (
  ...
  PRIMARY KEY (`id_p`),
  KEY `id_T` (`id_T`),
  CONSTRAINT `player_ibfk_1` FOREIGN KEY (`id_T`) REFERENCES `team` (`id_T`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `team` (
  ...
  PRIMARY KEY (`id_T`),
  KEY `id_L` (`id_L`),
  CONSTRAINT `team_ibfk_1` FOREIGN KEY (`id_L`) REFERENCES `league` (`id_L`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-12 17:05:14
